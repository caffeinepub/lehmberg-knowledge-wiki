...
import type { UserRole as _UserRole, WikiPage as _WikiPage } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createPage(arg0: string, arg1: string, arg2: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async deletePage(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getPage(arg0: bigint): Promise<WikiPage | null> {
        if (this.processError) {
            try {
    ...
    async getPageByTitle(arg0: string): Promise<WikiPage | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getPageByTitle(arg0);
                return from_candid_opt_n5(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPagesByTag(arg0: string): Promise<Array<WikiPage>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPagesByTag(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async listPages(): Promise<Array<WikiPage>> {
        if (this.processError) {
            try {
                const result = await this.actor.listPages();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updatePage(arg0: bigint, arg1: string, arg2: string, arg3: Array<string>): Promise<boolean> {
        if (this.processError) {
            try {
...
function from_candid_opt_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_WikiPage]): WikiPage | null {
